...
export default function FullscreenWarningOverlay({
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/80 backdrop-blur-md flex items-center justify-center p-4">
      <div className="w-full max-w-lg bg-[#15171A] border-4 border-[#E85D04] rounded-[2.5rem] p-8 shadow-2xl text-center space-y-6 animate-radar text-white">
        ...
        {/* Warning Icon */}
        <div className="w-20 h-20 bg-rose-950/80 border-2 border-[#E85D04] rounded-full flex items-center justify-center mx-auto text-[#E85D04] shadow-lg animate-bounce">
          <AlertTriangle className="w-10 h-10" />
        </div>

        <div className="space-y-2">
          <span className="px-3 py-1 bg-rose-950/80 text-[#E85D04] border border-[#E85D04] rounded-full text-xs font-mono font-bold tracking-widest uppercase">
        ...
        <div className="bg-rose-950/50 p-6 rounded-2xl border-2 border-rose-800 space-y-2">
          <p className="text-xs text-white/90 font-mono font-bold uppercase tracking-wider">
